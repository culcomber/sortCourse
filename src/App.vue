...
<template :style="card">
  <div style="margin: -8px">
    <img src="https://i.loli.net/2019/09/03/erwnatMTb197K8F.png" width="100%" style="position: fixed;z-index: -1;">
<!--跳转页面 数据共享-->
    <ul>
...
<!--      <li><router-link to="/checkResult">查看结果</router-link></li>-->
    </ul>
